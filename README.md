...
* **🛒 [UI React Store](https://ui-react-loja.vercel.app/)** - E-commerce moderno com foco em performance e design responsivo.
* **🏗️ [Estúdios](https://marcossoftwareengineering.github.io/Studios/)** - Gestão de tarefas e controle de qualidade em tempo real.
* **🔐 [Tela Login React](https://tela-loguin-react-v9hx.vercel.app/)** - Interface de autenticação otimizada para múltiplos dispositivos.

### 📘 Formação Acadêmica

* 🎓 **Pós-graduação:** Engenharia de Software - Faculdade Metropolitana de São Paulo.
* 🎓 **Graduação:** Análise e Desenvolvimento de Sistemas - Estácio de Sá.
...
[![Marvin Site Builders](https://img.shields.io/badge/Portfolio-Marvin_Site_Builders-000000?style=for-the-badge&logo=web&logoColor=white&labelColor=FF5E00)](https://www.marvinsitbilders.com/)
